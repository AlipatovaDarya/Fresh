...
@Composable
fun TopBar(currentScreen : String, arrowBack: Boolean, navController: NavHostController){

    Row (verticalAlignment = Alignment.Top,
        horizontalArrangement = Arrangement.Start,
        modifier = Modifier
            .fillMaxWidth()
            .padding(top = 16.dp, bottom = 6.dp, start = 24.dp)
    ) {
        Column {
            Image(painter = painterResource(R.drawable.orange_icon), contentDescription = "Иконка приложения", modifier = Modifier
                .size(50.dp)
                .padding(end = 10.dp),
